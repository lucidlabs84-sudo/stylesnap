...
export const translations = {
  en: {
    ...
    clickToLock: 'Click to lock element',
    ...
    assistMode: 'Assist',
    floatingBtn: 'Show floating button',
    // Tokens Tab
    ...
    autoInspect: 'Auto-inspect',
    autoCopyOnLock: 'Auto-copy on lock',
    showTailwindOverlay: 'Show Tailwind in overlay',
    shortenCSS: 'Shorten CSS',
  ...
  zh: {
    ...
    autoInspect: '自动审查',
    autoCopyOnLock: '锁定时自动复制',
    showTailwindOverlay: '在悬浮窗显示 Tailwind',
    shortenCSS: '精简 CSS',
    // Floating Button Tooltips
    btnTooltip: 'StyleSnap\n点击：开关审查模式\n拖拽：移动位置',
    btnInspect: '审查元素',
